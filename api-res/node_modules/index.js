...
app.get('/api/producto', function (req, res) {
    Product.find({},(error,products)=>
    {
        ...
        if(!products) return res.status(404).send({message:'No hay productos en la BDD'})
...
mongoose.connect('mongodb://admin:admin@ds155130.mlab.com:55130/mongotest',(err,res)=>
{
    if(err)throw err
